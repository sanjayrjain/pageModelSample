...
import static com.FK.base.BaseFactory.catHash;
import static com.FK.util.commonfunctions.generateRandomAddress;
import static com.FK.util.commonfunctions.verifyCurrentURLRequest;
...
public class Checkout extends AbstractPage {
 ...
 public void pricecheckinOrderpage()
 {
	 ...
	 System.out.println(finalprice);
 	if(getcurrentURL().contains("www.FK.com"))
 		...
 		else if (getcurrentURL().contains("www.FK.ca")) {
